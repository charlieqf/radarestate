# Site Card: 45 WATT STREET NEWCASTLE

## Rank

7 in the current Newcastle-Hunter automated site-screening cut.
...
- Address signal: 45 WATT STREET NEWCASTLE
- Lot reference: 20//DP1204023 / DP1204023
...
| Height | 35.0m | [Open source](https://mapprod3.environment.nsw.gov.au/arcgis/rest/services/Planning/EPI_Primary_Planning_Layers/MapServer/5) |
...
| --- | --- |
| Plan area | 4,369 sqm |
| Geometry area | 6,221 sqm |
| Perimeter | 398.2 m |
| BBox width | 88.4 m |
| BBox height | 134.9 m |
| Frontage candidate | 145.8 m |
