# Site Card: 601 PACIFIC HIGHWAY ST LEONARDS

## Rank

4 in the current Sydney automated site-screening cut.
...
- Lot reference: 71//DP749690 / DP749690
- Latest mapped signal date: 2026-01-06
...
| FSR | 20.00 | [Open source](https://mapprod3.environment.nsw.gov.au/arcgis/rest/services/Planning/EPI_Primary_Planning_Layers/MapServer/1) |
| Height | 259.0m | [Open source](https://mapprod3.environment.nsw.gov.au/arcgis/rest/services/Planning/EPI_Primary_Planning_Layers/MapServer/5) |
...
| Apparent site jurisdiction | North Sydney | - |
| Zoning EPI | North Sydney Local Environmental Plan 2013 | - |
...
| --- | --- |
| Plan area | - |
| Geometry area | 4,131 sqm |
| Perimeter | 266.7 m |
| BBox width | 85.1 m |
| BBox height | 62.8 m |
| Frontage candidate | 233.4 m |
