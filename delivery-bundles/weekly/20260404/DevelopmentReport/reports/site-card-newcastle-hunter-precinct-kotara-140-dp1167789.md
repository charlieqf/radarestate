# Site Card: 88 PARK AVENUE KOTARA

## Rank

6 in the current Newcastle-Hunter automated site-screening cut.

## Snapshot

- Watchlist bucket: **Kotara**
- Watchlist precinct: **Kotara**
...
- Address signal: 88 PARK AVENUE KOTARA
- Lot reference: 140//DP1167789 / DP1167789
- Latest mapped signal date: 2026-02-05
...
| Field | Value | Source |
| --- | --- | --- |
| Zoning | E1 (Local Centre) | [Open source](https://mapprod3.environment.nsw.gov.au/arcgis/rest/services/Planning/EPI_Primary_Planning_Layers/MapServer/2) |
| FSR | 2.00 | [Open source](https://mapprod3.environment.nsw.gov.au/arcgis/rest/services/Planning/EPI_Primary_Planning_Layers/MapServer/1) |
| Height | 14.0m | [Open source](https://mapprod3.environment.nsw.gov.au/arcgis/rest/services/Planning/EPI_Primary_Planning_Layers/MapServer/5) |
...
| --- | --- |
| Plan area | 2,416 sqm |
| Geometry area | 3,441 sqm |
| Perimeter | 245.4 m |
| BBox width | 68.1 m |
| BBox height | 70.7 m |
| Frontage candidate | 67.2 m |
