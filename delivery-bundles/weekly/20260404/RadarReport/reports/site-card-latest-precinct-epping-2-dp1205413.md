# Site Card: 37-41 OXFORD STREET EPPING

## Rank

3 in the current Sydney automated site-screening cut.
...
- Lot reference: 2//DP1205413 / DP1205413
- Latest mapped signal date: 2026-03-25
...
| FSR | 4.50 | [Open source](https://mapprod3.environment.nsw.gov.au/arcgis/rest/services/Planning/EPI_Primary_Planning_Layers/MapServer/1) |
| Height | 72.0m | [Open source](https://mapprod3.environment.nsw.gov.au/arcgis/rest/services/Planning/EPI_Primary_Planning_Layers/MapServer/5) |
...
| --- | --- |
| Plan area | 4,976 sqm |
| Geometry area | 7,220 sqm |
| Perimeter | 441.8 m |
| BBox width | 117.0 m |
| BBox height | 124.3 m |
| Frontage candidate | 69.0 m |
