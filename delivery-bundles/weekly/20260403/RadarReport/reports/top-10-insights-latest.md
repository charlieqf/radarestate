...
## 10. Data asymmetry is shaping the quality and tone of the output

- Finding: Sydney can support target-pressure narratives; Hunter currently cannot, because housing-target coverage is absent there.
- Evidence: Target coverage: Greater Sydney 10/22; Hunter 0/5.
- Why it matters: That means the system should not pretend both regions support the same style of argument. Sydney can be framed around target pressure plus policy plus activity; Hunter is currently better framed around activity plus proposal plus risk.
- Action: Keep report language region-specific rather than forcing one national narrative onto very different data environments.
